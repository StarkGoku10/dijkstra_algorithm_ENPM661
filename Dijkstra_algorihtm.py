...
border_thickness = 5
cv2.rectangle(image, (0, map_height - 1), (map_width - 1, 0), PADDING_COLOR, border_thickness)
...
cv2.rectangle(image, (275 - padding, map_height - 400 - padding), (350 + padding, map_height + padding), PADDING_COLOR, -1)
...
for i in range(polygon_sides):
    ...
    y = map_height - (250 + ((polygon_length) * np.sin(angle)))
...
cv2.rectangle(image, (1020 - padding, map_height - 50 + padding), (1100 + padding, map_height - 450 - padding), PADDING_COLOR, -1)  # Right vertical part of U
cv2.rectangle(image, (1020, map_height - 50), (1100, map_height - 450), OBS_COLOR, -1)
cv2.rectangle(image, (900 - padding, map_height - 50 + padding), (1100 + padding, map_height - 125 - padding), PADDING_COLOR, -1)  # Top vertical part of U
cv2.rectangle(image, (900, map_height - 50), (1100, map_height - 125), OBS_COLOR, -1)
cv2.rectangle(image, (900 - padding, map_height - 375 + padding), (1100 + padding, map_height - 450 - padding), PADDING_COLOR, -1)  # Bottom Horizontal part of U
...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            if not Validity(s_x, s_y, obs_space) or image[s_y][s_x].tolist() == OBS_COLOR or image[s_y][s_x].tolist() == PADDING_COLOR:
